/mnt/huangjiaxin/3d-defense/experiments_output/ablation_defense_epochs_20260226_154309/def_ep32.log
# 3D Defense 统一配置
...
defense:
  ...
  robustness:
    enabled: true
    weight: 1.85
    # 标定思路：覆盖更强攻击（如 ~10× lr）下的参数漂移邻域，避免过大导致“随机重采样权重”。建议 0.008~0.012。
    noise_scale: 0.008
    every_k_steps: 1
